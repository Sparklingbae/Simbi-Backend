...
app.use(`/api/v${settings_1.default.API_VERSION}/study-plan`, studyPlan_route_1.default);
app.use(`/api/v${settings_1.default.API_VERSION}/preasssessment`, studyPlan_route_1.default);
/*
